...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form action="admin/users/themadmin" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary" style="width: 500px;">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea id="diachi" name="diachi" class="form-control"  placeholder="Vui lòng điền địa chỉ"  value="{{old('diachi')}}"></textarea>
